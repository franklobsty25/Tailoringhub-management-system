...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('blouse_dress_skirts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('blouse_dress_skirts');
    }
};
